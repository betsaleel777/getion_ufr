<div class="outer-w3-agile mt-3">
 ...
 <div class="form-group">
   <button type="button" onclick="updateParcours()" class="btn btn-primary mb-2">envoyer</button>
 </div>
 ...
 <form method="post">
      ...
      <div class="form-group">
        ...
        <input id="id_parcours" type="hidden" name="id_parcours" <?php if(isset($idParcours)){ echo 'value="'.$idParcours.'"' ;} ?>>
        <input id="id" type="hidden" name="id" <?php if(isset($idSempar)){ echo 'value="'.$idSempar.'"' ;} ?>>
...
<script src="js/updateParcours.js"></script>
